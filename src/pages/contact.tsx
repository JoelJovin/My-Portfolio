    ...
    return (
        <Fragment>
            <Head>
                ...
                <title>Joel AP &mdash; Contact with me</title>
            </Head>
                ...
                <div className={styles.contactCards}>
                    ...
                    <div className={styles.contactCardsCard}>
                        <ul className={styles.contactCardsCardList}>
                            <li className={styles.contactCardsCardListItem}>
                                <span>Gmail:</span>
                                <a href="mailto:Intelligentquantum@Gmail.com">apjoel2002@gmail.com</a>
                            </li>
                            <li className={styles.contactCardsCardListItem}>
                                <span>SecondaryMail:</span>
                                <a href="mailto:Intelligentquantum@ProtonMail.com">joel@gmail.com</a>
                            </li>
                            <li className={styles.contactCardsCardListItem}>
                                <span>Discord:</span>
                                <span>joel#6439</span>
